...
5. **Operator lifecycle/recovery UX — next.** Consolidate initialization, inspect/status, pause/resume, retry/reject/reconcile, paid approval, daemon lifecycle, and diagnostics into a coherent documented operator surface.
