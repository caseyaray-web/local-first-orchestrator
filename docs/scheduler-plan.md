...
6. **Runtime metrics and adaptive sizing — next.** Persist real-run performance/outcome measurements and use them to adjust ticket/context sizing within explicit policy bounds.
