...
def run_command(args: argparse.Namespace) -> int:
    ...
    try:
        if args.command=="migrate": pass
            ...
            print(json.dumps(ctl.activate_native_release_revalidation(args.task_id, revalidation_id=args.revalidation_id, operator_id=args.operator_id, reason=args.reason, request_key=args.request_key), sort_keys=True))
